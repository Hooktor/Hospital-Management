...
SECRET_KEY = 'django-insecure-l9j(3)6*bgf(#h--a3!n^wie^cafw&*^s&r1$)64$-(j)%uzyo'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'hospitaldb',  # Corrected database name
        'USER': 'root',       # Replace with your MySQL user
        'PASSWORD': 'Hamza@123',  # Replace with your MySQL password
